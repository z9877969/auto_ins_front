...
export const blockContent = {
  ...
  [orderTypes.ORDER_CHECK]: {
    ...
    descr:
      'Для підтвердження згоди на укладання Договору введіть і відправте код з повідомлення отриманого в вайбер або смс (6 цифр, відправник EUA), що було відправлено на номер:',
